                        ...
                        while (!valid) {
                            try {
                                ...
                                if (!service.validateProductCode(code)) {
                                    throw new BillingException("❌ Invalid product code. Must be a 4-digit positive number.");
                                }
                                valid = true;
                        ...
                        while (!valid) {
                            try {
                                ...
                                if (!service.validateQuantity(qty)) {
                                    throw new BillingException("❌ Invalid quantity. Must be greater than 0.");
                                }
                                valid = true;
                            } catch (BillingException e) {
                                System.out.println(e.getMessage());
